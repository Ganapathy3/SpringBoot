          ...
          data: "",
           ...
           // $('#myrenewalview').html(table);
            ...
            /* button creation coloumn 1 */    
                 ...
                 /* Edit button creation start */
                	 ...
                	 "fnCreatedCell":function(data){
                	                  $(data).html(
                	                  "<input type='button' value='edit' class='btn btn-warning' data-toggle='modal' data-target='#myModal1'>");
                	                  }
                 
                 /* Edit button creation end */
                 
                 },  
                 
                 /* button creation coloumn 2 */
                 { title:"Delete","data": "previousExperience" ,
                 	
                     
                	 /* Edit button creation start */
                	 "fnCreatedCell":function(data){
                	                  $(data).html(
                	                  "<input type='button' value='Delete' class='btn btn-danger' data-toggle='modal' data-target='#myModal'>");
                	                  }
            ...
            $('#example tbody').on('click', '.btn-danger', function () {
                ...
                var phone1 = $(this).closest('tr').find('td:eq(1)').text();
             
                
                document.getElementById('nameForDelete').value = name1;
                document.getElementById('Phone').value = phone1;
              
            
            });             /// this function for delete  end ------->>>>>>
            
            <!-- data retrived for deleting purpose -->
            <!-- Next step Create api for delete -->
...
<div class="row">
    ...
    <div class="col-sm-4"><b>Name:</b> </div>
     <div class="col-sm-4"><b><input  id="nameForDelete"  type ="text" name="name"  readonly> </b></div>
   </div></br>
...
<div class="col-sm-4"><b>Phone:</b> </div>
<div class="col-sm-4"><b><input id="Phone"   type ="text" name="phone"></b> </div>
</div></br>
...
<div class="col-sm-4"> 
   <b><input type="submit" name="submit" id="submit" value="Delete" ></b>
</div> 
<div class="col-sm-4"> 
